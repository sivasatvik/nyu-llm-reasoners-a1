...
% 1:01.86 total
            ...
            \item \textbf{Experiments with tokenizers}
                \begin{enumerate}[label=\alph*.]
                    \item The tokenizer's compression ratio (bytes/token) is around 2.6673in a sample of 10 documents from TinyStories dataset.
